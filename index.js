...
const exampleArray = ["banana", 1];

// EXERCISE 2
// Nest an array inside array nestedArray. After that nestedArray should contain an
//array as an element.

const nestedArray = ["example", 10, ["lemon", 13], true];

// EXERCISE 3
// Change the value of firstNumber to equal the first value of the numbers array
...
// EXERCISE 5
// Change the value of nestedNumber to equal the fourth number of nestedNumbers using
//bracket notation.
...
// EXERCISE 8
// Put "hamster" onto the start of unshiftedPets variable by using the array method
//unshift.
